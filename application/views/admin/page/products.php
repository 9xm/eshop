      ...
      <div class="page_title_block">
        ...
        <div class="col-md-12">
          <form id="filterForm" accept="" method="GET">
            ...
            <div class="col-md-3">
              <select class="form-control select2 filter" name="vendor">
                <option value="">-- Vendor --</option>
                <?php 
                  foreach ($vendor_list as $key => $value) {
                    ?>
                    <option value="<?=$value->id?>" <?=(isset($_GET['vendor']) && $_GET['vendor']==$value->id) ? 'selected="selected"' : '' ?>><?=$value->user_name?></option>
                    <?php
                  }
                ?>
              </select>
