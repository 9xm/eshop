            ...
            <div class="section-body">
              ...
              <div class="form-group">
                <label class="col-md-3 control-label"><?=$this->lang->line('select_image_lbl')?> :-
                    <p class="control-label-help hint_lbl">(<?=$this->lang->line('recommended_resolution_lbl')?>: 470X420)</p>
                    ...
                    <p class="control-label-help hint_lbl">(Please add transparent image or white background image for good looking)</p>
                </label>
                <div class="col-md-6">
