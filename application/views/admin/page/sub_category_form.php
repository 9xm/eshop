        ...
        <form action="<?php if(!isset($sub_category)){ echo site_url('admin/SubCategory/addForm').'?redirect='.$redirect; }else{  echo site_url('admin/SubCategory/editForm/'.$sub_category[0]->id).'?redirect='.$redirect;} ?>" method="post" id="categoryForm" class="form form-horizontal" enctype="multipart/form-data">
          <div class="section">
            <div class="section-body">
              ...
              <div class="form-group">
                <label class="col-md-3 control-label">Seller Percentage :-
                
                </label>
                <div class="col-md-6">
                  <input type="text" placeholder="Seller Percentage" id="percentage" maxlength="3" min="0" max="100" name="percentage" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="<?php if(isset($sub_category)){ echo $sub_category[0]->seller_percentage;} ?>">
                </div>
              </div> 
              <br/>
              <div class="form-group">
