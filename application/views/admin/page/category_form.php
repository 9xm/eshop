          ...
          <div class="section">
            <div class="section-body">
             ...
             <?php /* <div class="form-group">
                <label class="col-md-3 control-label">Vendor Percentage :-
                
                </label>
                <div class="col-md-6">
                  <input type="text" placeholder="Vendor Percentage" id="percentage" maxlength="3" min="0" max="100" name="percentage" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="<?php if(isset($category)){ echo $category[0]->vendor_percentage;} ?>">
                </div>
              </div> */ ?>
              <hr/>
              <div class="form-group">
