    ...
    <div class="card">
      ...
      <div class="card-body mrg_bottom" style="padding: 0px">
        ...
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li role="presentation"><a href="#seller_settings" aria-controls="seller-settings" role="tab" data-toggle="tab"><i class="fa fa-gear"></i> Seller Settings</a></li>
        </ul>
          ...
          <div class="col-md-12">
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane" id="seller_settings">
                  <form action="<?=site_url('admin/pages/seller_settings')?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
                  <input type="hidden" name="action_for" value="seller_settings">
                <?php //print_r($seller_settings_row); ?>
                <div class="section">
                  <div class="section-body">
                    <div class="form-group">
                      <label class="col-md-4 control-label">Banner headding<span class="required_fields">*</span> :-</label>
                      <div class="col-md-6">
                        <input type="text" name="home_banner_headding" value="<?php echo get_seller_option('home_banner_headding', $sellerrow);?>" class="form-control" required="required">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-4 control-label">Banner sub headding :-</label>
                      <div class="col-md-6">
                        <input type="text" name="home_banner_sub_headding"  value="<?php echo get_seller_option('home_banner_sub_headding', $sellerrow);?>" class="form-control" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-4 control-label">Banner learn more link :-</label>
                      <div class="col-md-6">
                        <input type="text" name="home_banner_learn_more_link"  value="<?php echo get_seller_option('home_banner_learn_more_link', $sellerrow);?>" class="form-control" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-4 control-label">Banner T&C link:-</label>
                      <div class="col-md-6">
                        <input type="text" name="home_banner_t_c_link"  value="<?php echo get_seller_option('home_banner_t_c_link', $sellerrow);?>" class="form-control" >
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="col-md-4 control-label">Banner  Image<span class="required_fields">*</span> :-
                        <p class="control-label-help hint_lbl">(<?=$this->lang->line('recommended_resolution_lbl')?>: 602x452)</p>
                        <p class="control-label-help hint_lbl">(<?=$this->lang->line('accept_img_files_lbl')?>)</p>
                      </label>
                      <div class="col-md-6">
                        <div class="fileupload_block">
                          <input type="file" name="home_banner_image" id="fileupload" accept=".jpg, .png, jpeg, .PNG, .JPG, .JPEG">
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label">First card title:-</label>
                      <div class="col-md-6">
                        <input type="text" name="home_first_card_title"  value="<?php echo get_seller_option('home_first_card_title', $sellerrow);?>" class="form-control" >
                      </div>
                    </div>              
                    <div class="form-group">
                      <label class="col-md-4 control-label">First card description:-</label>
                      <div class="col-md-6">
                        <textarea rows="6" name="home_first_card_description" class="form-control"><?php echo get_seller_option('home_first_card_description', $sellerrow);?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-4 control-label">First card image:-
                        <p class="control-label-help hint_lbl">(<?=$this->lang->line('recommended_resolution_lbl')?>: 431x216)</p>
                        <p class="control-label-help hint_lbl">(<?=$this->lang->line('accept_img_files_lbl')?>)</p>
                      </label>
                      <div class="col-md-6">
                        <div class="fileupload_block">
                          <input type="file" name="home_first_card_image" id="fileupload" accept=".jpg, .png, jpeg, .PNG, .JPG, .JPEG">
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label">Second card title:-</label>
                      <div class="col-md-6">
                        <input type="text" name="home_second_card_title"  value="<?php echo get_seller_option('home_second_card_title', $sellerrow);?>" class="form-control" >
                      </div>
                    </div>              
                    <div class="form-group">
                      <label class="col-md-4 control-label">Second card description:-</label>
                      <div class="col-md-6">
                        <textarea rows="6" name="home_second_card_description" class="form-control" required=""><?php echo get_seller_option('home_second_card_description', $sellerrow);?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-4 control-label">Second card image:-
                        <p class="control-label-help hint_lbl">(<?=$this->lang->line('recommended_resolution_lbl')?>: 431x216)</p>
                        <p class="control-label-help hint_lbl">(<?=$this->lang->line('accept_img_files_lbl')?>)</p>
                      </label>
                      <div class="col-md-6">
                        <div class="fileupload_block">
                          <input type="file" name="home_second_card_image" id="fileupload" accept=".jpg, .png, jpeg, .PNG, .JPG, .JPEG">
