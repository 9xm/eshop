      ...
      <tbody>
       ...
       foreach ($order_list as $key => $row) 
       {
        ...
        <tr class="item_holder">
          <td><a href="<?php echo site_url("vendor/orders/".$row->order_unique_id);?>"><?php echo $row->order_unique_id;?></a></td>
          <td style="word-wrap: break-word;"><?php echo $row->product_title;?></td>
          <td style="word-wrap: break-word;"><?php echo $row->product_qty;?></td>
          <td style="word-wrap: break-word;"><?php echo $row->product_size;?></td>
...
<script type="text/javascript">
  ...
  $(".btn_status").on("click",function(e){  
    ...
    var href='<?=base_url()?>vendor/order/order_status_form/'+_id;
  ...
  $(".actions").click(function(e){
    ...
    var href='<?=base_url()?>vendor/pages/perform_multipe';
  ...
  $(".btn_delete").click(function(e){
    ...
    var href='<?=base_url()?>vendor/order/delete/'+_id;
