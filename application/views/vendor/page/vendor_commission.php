          ...
          <table class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <th class="cat_action_list">Paid Details</th>
              </tr>
            </thead>
            <tbody>
              <?php 
              ...
              <tr class="item_holder">
                ...
                <td><a href="<?php echo site_url("vendor/pages/order_summary/".$row->order_id);?>"><?php echo ($row->order_id) ? $row->order_id : '-'?></a></td>
                ...
                <td nowrap="">
                  ...
                  {
                  ?>
                  <a href="javascript:void(0);" class="btn btn-primary" data-toggle="tooltip" data-tooltip="Unpaid">Unpaid</a>
                  <?php 
                  }
                  else
                  {
                ...
                <td>
                  Transaction :- <?php echo ($row->transaction) ? $row->transaction : '-'?><br>
                  Payment through :- <?php echo ($row->paid_type) ? $row->paid_type : '-'?><br>
                  Payment date :- <?php echo date('d-m-Y',$row->paid_date);?>
                </td>
              <?php } ?>
              </tr>
             <?php    
