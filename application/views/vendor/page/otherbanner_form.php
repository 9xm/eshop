  ...
  <div class="col-md-12">
    <?php 
      if(isset($_GET['redirect'])){
        ...
        echo '<a href="'.base_url('admin/other-banner').'"><h4 class="pull-left btn_back" style=""><i class="fa fa-arrow-left"></i> Back</h4></a>'; 
      }
    ?>
    <div class="card">
      ...
      <div class="card-body mrg_bottom"> 
        <form action="<?php if(!isset($banner)){ echo site_url('admin/OtherBanner/addForm').'?redirect='.$redirect;}else{  echo site_url('admin/OtherBanner/editForm/'.$banner[0]->id).'?redirect='.$redirect;} ?>" method="post" id="categoryForm" class="form form-horizontal" enctype="multipart/form-data">
          <div class="section">
            <div class="section-body">
              ...
              <div class="form-group">
                <label class="col-md-3 control-label"><?=$this->lang->line('select_image_lbl')?> :-
                    <p class="control-label-help hint_lbl">(<?=$this->lang->line('recommended_resolution_lbl')?>: 246X176)</p>
