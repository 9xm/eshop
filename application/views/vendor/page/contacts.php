    ...
    <div class="card">
      ...
      <div class="card-body mrg_bottom" style="padding: 0px">
        ...
        <ul class="nav nav-tabs" role="tablist" style="margin-bottom: 0px">
          ...
          <li role="presentation"><a href="#subscribe_list" aria-controls="subscribe_list" role="tab" data-toggle="tab"><i class="fa fa-envelope"></i> Subscribe List</a></li>
        </ul>
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane" id="subscribe_list">
              <div class="col-md-12 mrg-top manage_comment_btn">
                  <table  class="datatable table table-striped table-bordered table-hover" style="margin-top: 70px !important">
                    <thead>
                      <tr>
                        <th><?=$this->lang->line('email_lbl')?></th>    
                        <th><?=$this->lang->line('date_lbl')?></th>    
