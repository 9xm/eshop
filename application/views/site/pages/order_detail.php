                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="mr-xl-6">
                            <div class="border-bottom border-color-1 mb-5">
                                <h3 class="section-title mb-0 pb-2 font-size-35">Order Details</h3>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php //echo "==========".$value->pro_order_status;
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="product_timeline_block">
                                            <section class="cd-horizontal-timeline">
                                                <div class="timeline">
                                                  <?php //echo "<pre>";print_r($refund_data);print_r($value); echo "</pre>";
                                                  ...
                                                  <?php $yellowbar++;  } 
                                                  $refund_barcount=0;
                                                  if(isset($refund_bar[$value->product_id])){
                                                      $refund_bar_item=$refund_bar[$value->product_id];
                                                  ?>
                                                  <div class="dot <?php if($refund_bar_item['request_status'] == 1){ echo 'active_dot';}else{ echo 'deactive_dot'; } ?>" id="refund-<?=$value->product_id?>">
                                                    <span></span>
                                                    <date style="width: max-content"><?=$refund_bar_item['request_status_text']?></date>
                                                  </div>

                                                   <?php $refund_barcount++;  } ?> 
                                                  <div class="inside" style="width: <?=(20*($value->pro_order_status-3))+2?>% !important"></div>
                                                  
                                                  <?php if($refund_barcount>0){ for($i=1; $i<= $refund_barcount; $i++){ ?>
                                                  <div class="inside" style="width: <?=((20*$yellowbar)+(20*$i))+2?>% !important"></div>
                                                  <?php }} ?>
                                                </div>
                                                ...
                                                <?php
                                                    if(isset($refund_bar[$value->product_id])){
                                                        $refund_bar_item=$refund_bar[$value->product_id];
                                                     ?>
                                                     <article class="modal refund-<?=$value->product_id?>" style="display: block">
                                                       <date><?=date("M jS,y",$refund_bar_item['created_at'])?></date>
                                                       <h2><?=$refund_bar_item['request_status_text']?></h2>
                                                       <p><?=$refund_bar_item['refund_reason']?></p>
                                                     </article>
                                                     <?php
                                                }else{
