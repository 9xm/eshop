              ...
              <div class="row">
                ...
                <form class="app-login-form" method="post">
                  ...
                  <div class="form-group">
                    <label for="tel" class="frm-lbl">Sign Up to view your profile</label><br>
                    <div class="input-group mb-2">
                      <div class="input-group-prepend">
                        <div class="input-group-text">+91</div>
                      </div>
                      <input type="text" name="mobile" class="form-control" maxlength="10" placeholder="Mobile Number">
                    </div>
                  </div>
