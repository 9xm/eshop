<!-- ========== FOOTER ========== -->
            ...
            <div class="pt-8 pb-4 bg-gray-13">
                <div class="container mt-1">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="mb-6">
                                <a href="<?=base_url('/')?>" class="d-inline-block"><img src="<?=base_url('assets/images/').APP_LOGO_2?>" alt="" class="img-fluid"></a> 
                            </div>
                            <div class="mb-4">
        ...
        <script src="<?php echo base_url(); ?>assets/site_assets/js/cust_javascript.js?ver=<?php echo time(); ?>"></script>
        ...
        <script>
            function jqUpdateSize()
            {
                ...
                if (width < 1200 && width > 768) {
                    ...
                    $('.sasdasdsdasdasdasdasd').css('height','440px');
                    ...
                    //$('.headerwhislist').hide();
					 ...
					 $('.sasdasdsdasdasdasdasd').css('height','240px');
				   }
				
				else
                {
                    $('.sasdasdsdasdasdasdasd').css('height','760px');
