...
<head>
    ...
    echo $current_page . ' | ';
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/site_assets/css/theme.css">
		 ...
		 <link rel="stylesheet" href="<?php echo base_url(); ?>assets/site_assets/css/custom.css">
        <!-- Sweetalert popup -->
    ...
    <li class="u-has-submenu u-header-collapse__submenu" style="margin-top: 10px;">  <i class="font-size-22 ec ec-user"></i> <strong><?php echo $_SESSION['user_name'];?></strong></li>
<?php
}
...
?>
                            ...
                            <!-- End Search Bar -->
                            <!-- Header Icons -->
                            <div class="col col-xl-auto text-right text-xl-left pl-0 pl-xl-3 position-static header-right">
                                <div class="d-inline-flex">
                                    <ul class="d-flex list-unstyled mb-0 align-items-center mobile-space">
                                        <!-- Search -->
                                        <li class="col d-xl-none px-2 px-sm-3 position-static small-search">
                                        ...
                                        <li class="col d-xl-block"><a href="http://seller.becarto.in" target="_blank" class="text-gray-90 btn btn-outline-secondary sell-button rounded-lg hide-mobile-sell" data-toggle="tooltip" data-placement="top" title="Vendor Register"><i class="fa fa-sign-in" aria-hidden="true"></i>
Sell</a></li>
                                        <?php
                                        if (!check_user_login()) {
                                        ?>
                                        ...
                                        <li class="col d-xl-block"><a href="<?php echo site_url('login-register'); ?>" class="text-gray-90 btn btn-outline-primary sell-button rounded-lg" data-toggle="tooltip" data-placement="top" title="Login/Register"><i class="fa fa-sign-in" aria-hidden="true"></i>
Login</a></li>
                                        ...
                                        <li class="col pr-xl-0 px-2 px-sm-3">
                                            <a href="<?php echo site_url('login-register'); ?>" class="position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                        ...
                                        <li class="col d-none d-xl-block"><a href="<?php echo site_url('wishlist'); ?>" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Favorites"><i class="font-size-22 ec ec-favorites"></i></a></li>-->											
										<li class="col d-xl-block pr-0">
										<nav class="navbar-dark navbar-expand-sm">
										<!--<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-list-4" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">										<span class="navbar-toggler-icon"></span>									  </button>-->
										<div class="collapse navbar-collapse" id="navbar-list-4">										<ul class="navbar-nav">	
										<li class="nav-item dropdown hide-profile-mobile">
										<a class="nav-link dropdown-toggle text-gray-90 rounded-circle" href="<?php echo site_url('my-account'); ?>" id="navbarDropdownMenuLink" style="color: #333e48;" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">													<i class="font-size-22 ec ec-user"></i>          											</a>											<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">											  <a class="dropdown-item" href="my-account">Dashboard</a>											   <a class="dropdown-item" href="my-account">Edit Profile</a>											  <a class="dropdown-item" href="my-orders">My Orders</a>											  <a class="dropdown-item" href="<?= base_url(); ?>site/logout">Log Out</a>											</div>										  </li>   										</ul>									  </div>									</nav>								</li>							<li class="hide-profile-mobile"><strong><?php echo $_SESSION['user_name'];?></strong></li>																												<li class="col d-none d-xl-block"><a href="<?= base_url(); ?>site/logout" class="text-gray-90 btn btn-outline-primary rounded-lg" data-toggle="tooltip" data-placement="top" title="Logout"><i class="fa fa-sign-out d-inline" aria-hidden="true"></i>Logout</a></li>
                                        
                                        <li class="col pr-xl-0 px-2 px-sm-3">
                                            <a href="<?php echo site_url('my-cart'); ?>" class="position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                                <i class="font-size-22 ec ec-shopping-bag"></i>
                                    ...
                                    <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                        <ul class="navbar-nav u-header__navbar-nav">
                                            ...
                                            <li class="nav-item u-header__nav-item">
                                                <a class="nav-link active u-header__nav-link" href="<?php echo base_url('/') ?>">Home</a>
                                            </li>
			...
			<div class="mobile-search">		<form  action="<?= base_url('search-result') ?>" id="search_form" method="get" class="js-focus-state input-group px-3">			<input class="form-control"  name="keyword"  type="text" placeholder="<?= $this->lang->line('search_lbl') ?>" required>			<div class="input-group-append">				<button class="btn btn-primary px-3" type="submit"><i class="font-size-18 ec ec-search" id="searchProduct1"></i></button>			</div>		</form>		</div>
        </header>
        <!-- ========== END HEADER ========== -->