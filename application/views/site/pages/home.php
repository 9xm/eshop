        ...
        <main id="content" role="main">
			...
			<div class="container">
			<div class="mb-0 mt-3">
            <h3 class="section-title section-title__full d-inline-block mb-0 pb-2 font-size-22">Latest Offers</h3>
            </div>
			</div>
			<div class="bg-light-offer pt-4 border-top border-bottom border-color-1">           
           <!-- End Slider Section -->
            <div class="container">
                <?php
                ...
                ?>
                <!-- Banner -->
	            <div class="row mb-2 overflow-auto overflow-xl-visble">
				...
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-4" >
					<div class="content"> <a href="<?=base_url('offers/'.$row->offer_slug)?>">
							<div class="content-overlay rounded-circle shadow-sm rounded"></div> <img class="img-fluid img-thumbnail fit-image rounded-circle  p-3 mb-2 bg-white rounded" src="<?=$img_file?>">
							<div class="content-details fadeIn-bottom">
								<h3 class="content-title"><?=$row->offer_title?></h3>
								<p class="content-text"><i class="fa fa-link"></i> Shop Now</p>
							</div>
						</a> </div>
						<h6 class="text-center mt-2 mb-2 font-weight-bold" style="color:#333;">
						<a href="<?=base_url('offers/'.$row->offer_slug)?>"><?=$row->offer_title?></a>
						</h6>
...
<?php /*                     <div class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1">
...
?>
			 ...
			 <div class="container">
				<div class="d-flex mr-md-2 mt-4">
                 <h3 class="section-title section-title__full mb-0 pb-2 font-size-22">Browse Popular Category</h3>
                 </div>
			</div>
			<div class="mb-2 bg-light-category pb-4 pt-4 border-bottom border-top border-color-1">
                <div class="container">
                    ...
                    <div class="row min-height-564 align-items-center">
						...
						if(count($show_category) > 0)
						{
							foreach($show_category as $category){
								 $img_file='assets/images/category/'.$category->category_image;
								 $url=base_url('category/products/'.$category->id);  
								?>
								
								<div class="col-lg-3 col-md-4 col-sm-6" >
									<div class="content"> <a href="<?php echo $url; ?>">
											<div class="content-overlay"></div> <img class="img-fluid img-thumbnail fit-image " src="<?php echo $img_file; ?>">
											<div class="content-details fadeIn-bottom">
												<h3 class="content-title"><?php echo $category->category_name; ?></h3>
												<p class="content-text"><i class="fa fa-link"></i> Shop Now</p>
											</div>
										</a> </div>
										<a href="<?php echo $url; ?>"><h6 class="text-center mb-2 custom-heading"><?php echo $category->category_name; ?></h6></a>
                ...
                if(isset($show_category[0]) && !empty($show_category[0]))
                {
                   ...
                   /* if(count($show_category_pro1) > 4) 
                    {*/
						...
						$url = base_url('category/products/'.$show_category[0]->id);
            ?>
                ...
                <div class="container">
                    <div class="row min-height-564 align-items-center">
                        <div class="col-12 col-lg-4 col-xl-5 col-wd-6 d-none d-md-block">
                            <img class="img-fluid" src="<?=$img_file?>" alt="Image Description" style="height: 435px;width: 470px; object-fit: contain;">
                        </div>
                        <div class="col-12 col-lg-8 col-xl-7 col-wd-6 pt-6 pt-md-0">
                            <div class=" d-flex border-bottom border-color-1 mr-md-2">
                                <h3 class="section-title section-title__full mb-0 pb-2 font-size-22"><?php echo $show_category[0]->category_name; ?></h3> <span class="view-all"> <a href="<?php echo $url; ?>">View All </a></span>
                            </div>
            ...
            <?php 
                ...
                if(isset($show_category[2]) && !empty($show_category[2]))
                {
                    $this->db->select('*');
                    $this->db->from('tbl_product'); 
                    $this->db->where('status', '1'); 
                    $this->db->where('category_id', $show_category[2]->id);
                    $this->db->limit(16); 
                    $this->db->order_by('id', 'DESC');
                    $show_category_pro2 = $this->db->get()->result();
					
					$url = base_url('category/products/'.$show_category[2]->id);
					
					
                    
            ?>
			<div class="bg-light-custom pb-4 pt-4 border-top border-color-1">
            <div class="container">
                <!-- Laptops & Computers -->
                <div class="mb-6 position-relative">
                    <dv class="d-flex justify-content-between border-bottom border-color-1 flex-md-nowrap flex-wrap border-sm-bottom-0">
                        <h3 class="section-title section-title__full mb-0 pb-2 font-size-22"><?php echo $show_category[2]->category_name; ?></h3> <span class="view-all"> <a href="<?php echo $url; ?>">View All </a></span> 
                    ...
                    <div class="js-slick-carousel position-static u-slick u-slick--gutters-1 overflow-hidden u-slick-overflow-visble pt-3 pb-3"
                        ...
                        <div class="js-slide">
                            <ul class="row list-unstyled products-group no-gutters mb-0 overflow-visible">
                                ...
                                ?>
                                <li class="col-md-4 product-item product-item__card pb-2 mb-2 pb-md-0 border-bottom border-md-bottom-0">
                                    <div class="product-item__outer h-100 w-100">
                                        <div class="product-item__inner p-md-3 row no-gutters bg-white max-width-334">
                                            <div class="col col-lg-auto product-media-left">
                                                <a href="<?php echo site_url('product/'.$row->product_slug); ?>" class="d-block" style="max-width: 5.5rem;"><img class="img-fluid" src="<?=base_url().$img_file?>" alt="Image Description" style="width: 120px ;height: 112px;"></a>
                        ...
                        <div class="js-slide">
                            <ul class="row list-unstyled products-group no-gutters mb-0 overflow-visible">
                                ...
                                ?>
                                <li class="col-md-3 product-item product-item__card pb-2 mb-6 pb-2 mb-md-0 border-bottom border-md-bottom-0">
                                    <div class="product-item__outer h-100 w-100">
                                        <div class="product-item__inner p-md-3 row no-gutters bg-white max-width-334">
                                            <div class="col col-lg-auto product-media-left">
                                                <a href="<?php echo site_url('product/'.$row->product_slug); ?>" class="d-block" style="max-width: 5.5rem;"><img class="img-fluid" src="<?=base_url().$img_file?>" alt="Image Description" style="width: 120px ;height: 112px;"></a>
            ...
            <?php
                ...
                if(isset($show_category[3]) && !empty($show_category[3]))
                {
                    $this->db->select('*');
                    $this->db->from('tbl_product'); 
                    $this->db->where('status', '1'); 
                    $this->db->where('category_id', $show_category[3]->id);
                    $this->db->limit(16); 
                    $this->db->order_by('id', 'DESC');
                    $show_category_pro2 = $this->db->get()->result();
					
					$url = base_url('category/products/'.$show_category[3]->id);
					
					
                    
            ?>
			<div class="bg-light-custom pb-4 pt-4 border-color-1">
            <div class="container">
                <!-- Laptops & Computers -->
                <div class="mb-6 position-relative">
                    <dv class="d-flex justify-content-between border-bottom border-color-1 flex-md-nowrap flex-wrap border-sm-bottom-0">
                        <h3 class="section-title section-title__full mb-0 pb-2 font-size-22"><?php echo $show_category[3]->category_name; ?></h3> <span class="view-all"> <a href="<?php echo $url; ?>">View All </a></span> 
            ...
            <?php
                ...
                if(isset($show_category[4]) && !empty($show_category[4]))
                {
                    $this->db->select('*');
                    $this->db->from('tbl_product'); 
                    $this->db->where('status', '1'); 
                    $this->db->where('category_id', $show_category[4]->id);
                    $this->db->limit(16); 
                    $this->db->order_by('id', 'DESC');
                    $show_category_pro2 = $this->db->get()->result();
					
					$url = base_url('category/products/'.$show_category[4]->id);
					
					
                    
            ?>
			<div class="bg-light-custom pb-4 pt-4 border-bottom border-color-1">
            <div class="container">
                <!-- Laptops & Computers -->
                <div class="mb-6 position-relative">
                    <dv class="d-flex justify-content-between border-bottom border-color-1 flex-md-nowrap flex-wrap border-sm-bottom-0">
                        <h3 class="section-title section-title__full mb-0 pb-2 font-size-22"><?php echo $show_category[4]->category_name; ?></h3> <span class="view-all"> <a href="<?php echo $url; ?>">View All </a></span> 
                ...
                <div class="position-relative mt-4">
                    ...
                    <div class="js-slick-carousel u-slick position-static overflow-hidden u-slick-overflow-visble pb-7 pt-2 px-1"
                        ...
                        foreach ($new_arrival as $key => $row) 
                        {
                            ...
                            $img_file=$ci->_create_thumbnail('assets/images/products/',$thumb_img_nm,$row->featured_image,420,650);
            ...
            <div class="container mb-8">
			        ...
			        <div class="border-bottom border-color-1 mb-2">
                        <h3 class="section-title section-title__full d-inline-block mb-0 pb-2 font-size-22">Our Brands</h3>
                    </div>
                    ...
                    <div class="js-slick-carousel u-slick my-1"
                        ...
                        <div class="js-slide">
                            <a href="<?=$url?>" title="<?=$row->brand_name?>" class="link-hover__brand">
                                <img class="img-fluid img-thumbnail max-height-150 brand-fit-image" src="<?=$img_file?>" style="width: 220px;height: 170px;" alt="Image Description">
                            </a>
                        </div>
                        <?php } ?>
                    </div>
