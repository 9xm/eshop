...
class Site extends CI_Controller 
{
    ...
    public function index()
    {
       ...
       /* $data['brands_list'] = $this->api_model->brand_list();*/
        ...
        $data['banner_list2'] = $this->api_model->banner_list();*/
    ...
    public function testhome()
    {
       ...
       /* $data['brands_list'] = $this->api_model->brand_list();*/
        ...
        //$this->template->load('site/template', 'site/pages/home', $data);
        $this->load->view('site/pages/testhome',$data);
    }    
    ...
    public function page_not_found(){
        ...
        $this->load->view('site/pages/404', $data);
    }
    ...
    public function banners(){
        ...
        $data['banner_list'] = $this->api_model->banner_list();
        $this->load->view('site/pages/banners', $data);
    ...
    public function offers(){
        ...
        $this->load->view('site/pages/offers', $data);
    }
    ...
    public function category(){
        ...
        $data['category_list'] = $this->api_model->category_list();
        $this->load->view('site/pages/category', $data);
    }
    ...
    public function brand(){
        ...
        $data['brands_list'] = $this->api_model->brand_list();
        $this->load->view('site/pages/brand', $data);
    }
    ...
    public function sub_category(){
        ...
        $data['sub_category_list1'] = $this->api_model->sub_category_list($cat_id);
        ...
        $this->load->view('site/pages/sub_category', $data);
    }
    ...
    public function single_product($product_slug){
        ...
        $this->load->view( 'site/pages/single_product', $data);
    ...
    public function search(){
        ...
        $category_id =  ($slug!='') ? $this->common_model->getIdBySlug($where, 'tbl_category') : '';
...
*/
    public function get_wishlist()
    {
        ...
        $this->load->view('site/pages/wishlist', $data);
    }
    ...
    public function get_compare()
    {
        ...
        $data['current_page'] = 'Compare';
        $data['compare'] = $this->api_model->get_compare($this->user_id);

        $this->load->view('site/pages/compare', $data);
    }
    ...
    public function compare_action(){
        ...
        if($this->user_id==0){
            ...
            $row=$this->common_model->selectByids($where,'tbl_compare');

            $response=array();

            if(!empty($row)){

                $this->common_model->deleteByids($where, 'tbl_compare');

                $count=count($this->common_model->selectByids($where,'tbl_compare'));

                $response=array('icon_lbl' => 'Remove Compare','success' => '1', 'msg' => 'Remove Successfully', "is_favorite" => false);

            }
            else{

                $count_compare=count($this->db->get_where('tbl_compare',array('user_id' => $this->user_id))->result());
                ...
                if($count_compare < 3)
                {
                    ...
                    $last_id = $this->common_model->insert($data_usr, 'tbl_compare');

                    $count=count($this->common_model->selectByids($where,'tbl_compare'));

                    $response=array('icon_lbl' => 'Remove Compare','success' => '1', 'msg' => 'Add Successfully', "is_favorite" => true);
                }
                else
                {
                    $response=array('icon_lbl' => '','success' => '0', 'msg' => "You cannot add more than 3 products", "is_favorite" => false);
                }
            }
    ...
    public function cart_action(){
        ...
        if($this->user_id==0){
            ...
            $row=$this->db->get('tbl_product')->result();
            ...
            if($row){
                ...
                <img style="width:120px;" src="'.base_url().$img_file.'" />
                </div>
                ...
                <button type="submit" class="form-button btn px-2 btn-primary-dark transition-3d-hover" data-text="'.$this->lang->line('add_cart_lbl').'">'.$this->lang->line('add_cart_btn').'</button>
                </form>
                </div>
                </div>
    ...
    public function my_cart(){
        ...
        $this->load->view('site/pages/my_cart', $data);
    }
    ...
    public function buy_now()
    {
        ...
        if(empty($this->input->get('order_unique_id')))
        {
            ...
            redirect('/checkout');
            //$this->load->view('site/pages/checkout', $data);
        }
        else{
    ...
    function is_compare($user_id, $product_id){
        $where = array('user_id ' => $user_id , 'product_id' => $product_id);
    ...
    public function login_form(){
        ...
        if($this->input->post('mobile')){
            ...
            $this->load->view('site/pages/login_otp', $data);
        }else{
            $this->load->view('site/pages/login_form', $data);
        }
    ...
    public function login(){
                ...
                if($this->Setting_model->get_web_details()->g_captcha=='true'){
                    ...
                    if(!empty($this->input->post('g-recaptcha-response'))){
                        ...
                        if(!$responseData->success){
                            ...
                            $message=array('status' => '0','message' => $this->lang->line('robot_verify_failed'),'class' => 'error');
                            $this->session->set_flashdata('response_msg', $message);
                        }

                    }
                    else{
                        $message=array('status' => '0','message' => $this->lang->line('check_captch_err'),'class' => 'error');
                        $this->session->set_flashdata('response_msg', $message);
                    }
                ...
                if($row_usr){
                    ...
                    if($row_usr->user_password==md5($this->input->post('password'))){
                        ...
                        if($row_usr->status=='1')
                        {
                            ...
                            $message = array('message' => $this->lang->line('acc_deactived'),'status' => '0','class' => 'error');
                            $this->session->set_flashdata('response_msg', $message);  
                        }
                    }
                    else{

                        $message = array('message' => $this->lang->line('password_invaild'),'status' => '0','class' => 'error');
                        $this->session->set_flashdata('response_msg', $message);
                    }
                }else{
                    $message = array('message' => $this->lang->line('email_not_found'),'status' => '0','class' => 'error');
                    $this->session->set_flashdata('response_msg', $message);
                }
            }
        }
        ...
        {  
            $message = array('message' => $this->lang->line('all_required_field_err'),'status' => '0','class' => 'error');
            $this->session->set_flashdata('response_msg', $message);
        }
    ...
    private function get_product_list($type, $row_all, $id=0, $base_url='', $data='', $keyword='', $user_id='',$category=''){
        ...
        if(empty($row_all)){
            $this->load->view('site/pages/no_products', $data);
            return;
        }
        ...
        else if(!empty($this->input->get('sort')))
        {
            ...
            $row=$this->api_model->products_filter($type, $id, $this->page_limit, $page,'','','','','',$keyword, $user_id,$category);
        }
        ...
        $this->load->view('site/pages/products', $data);
    }
                ...
                if(!empty($my_cart)){
                    ...
                    foreach ($my_cart as $value){
                        ...
                        $data_order = array(
                            ...
                            'delivery_charge'  =>  $value->delivery_charge,
                            'pro_order_status' => '1',
                            //'vid'  =>  $this->common_model->selectByidsParam(array('id' => $value->product_id),'tbl_product','insert_id')
                            'vid'  =>  $this->common_model->selectByidsParam(array('id' => $value->product_id),'tbl_product','seller_id')
                        );
                        ...
                        /*$data_updateeeee = array(
                            'vid'  =>  $this->common_model->selectByidsParam(array('id' => $value->product_id),'tbl_product','insert_id')
                        );

                        $this->common_model->update($data_updateeeee, $order_id,'tbl_order_details');*/
    ...
    public function my_order($order_unique_id=NULL){
        ...
        if($order_unique_id!=NULL){
            ...
            if($rowRefund){
                $rowfund=array();
                foreach($rowRefund as $rRefund){
                    $request_status_text="";
                    switch($rRefund->request_status){
                        case 0:
                            $request_status_text="Refund pending";
                            break;
                        case 2:
                            $request_status_text="Refund process";
                            break;
                        case 1:
                            $request_status_text="Refund completed";
                            break;
                    }
                   ...
                   // completed=1
                    ...
                    $rowfund[$rRefund->product_id]=array(
                        'request_status'=> $rRefund->request_status,
                        'request_status_text'=> $request_status_text,
                        'refund_reason'=> $rRefund->refund_reason,
                        'created_at'=> $rRefund->created_at
                    );
                }
                $data['refund_bar'] = $rowfund;
            }
           ...
           // die;
            ...
            $this->load->view('site/pages/order_detail', $data);
        }
        else
        {
            ...
            $this->load->view('site/pages/my_orders', $data);
        }
    }
    ...
    public function my_account(){
        ...
        $this->load->view('site/pages/my_account', $data);
    ...
    public function change_password_page(){
        ...
        $this->load->view('site/pages/change_password', $data);
    }
    ...
    public function my_addresses(){
        ...
        $this->load->view('site/pages/addresses', $data);
    ...
    public function saved_bank_accounts(){
        ...
        $this->load->view('site/pages/saved_cards.php', $data);
    ...
    public function my_reviews(){
        ...
        $this->load->view('site/pages/my_reviews.php', $data);
    ...
    public function product_reviews(){
        ...
        $this->load->view('site/pages/product_reviews.php', $data);
    ...
    public function reset_password_page(){
        ...
        $this->load->view('site/pages/reset_password', $data);
    }
    ...
    public function contact_us(){
        ...
        $this->load->view( 'site/pages/contact', $data);
    }
    ...
    public function email_verify_post()
    {
        ...
        $user_name='Kishan';
        $user_email='kishankumarpatel04@gmail.com';
        ...
        if($user_email){
            ...
            if (empty($email)) {
                ...
                if($this->sendemail($user_email, $user_name, $subject, $body))
                {
    ...
    public function register_post()
    {
        ...
        $user_type = ucfirst($this->input->post('type'));

        $user_name = addslashes(trim($this->input->post('name')));
    ...
    public function vendor_register_form(){

        $data = array();
        $data['page_title'] = 'Seller Register';
        $data['current_page'] = 'Seller Register';

        $this->load->view('site/pages/vendor', $data);
    }
