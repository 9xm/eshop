...
class Pages extends CI_Controller
{
    ...
    public function seller_settings(){
        ...
        $data = array(
            'home_banner_headding'  =>  trim($this->input->post('home_banner_headding')),
            'home_banner_sub_headding'  =>  trim($this->input->post('home_banner_sub_headding')),
            'home_banner_learn_more_link'  =>  trim($this->input->post('home_banner_learn_more_link')),
            'home_banner_t_c_link'  =>  trim($this->input->post('home_banner_t_c_link')),
            'home_first_card_title'  =>  htmlentities(trim($this->input->post('home_first_card_title'))),
            'home_first_card_description'  =>  htmlentities(trim($this->input->post('home_first_card_description'))),
            'home_second_card_title'  =>  htmlentities(trim($this->input->post('home_second_card_title'))),
            'home_second_card_description'  =>  htmlentities(trim($this->input->post('home_second_card_description'))),
        );

        if ($_FILES['home_banner_image']['error'] != 4) {
            ...
            $image = date('dmYhis') . '_banner_' . rand(0, 99999) . "." . pathinfo($_FILES['home_banner_image']['name'], PATHINFO_EXTENSION);
        ...
        if ($_FILES['home_first_card_image']['error'] != 4) {
            /*if (file_exists('assets/images/' . $data_setting->web_logo_1)) {
                unlink('assets/images/' . $data_setting->web_logo_1);
            }*/
            ...
            $image = date('dmYhis') . '_first_' . rand(0, 99999) . "." . pathinfo($_FILES['home_first_card_image']['name'], PATHINFO_EXTENSION);

            $config['file_name'] = $image;

            $this->load->library('upload', $config);

            if (!$this->upload->do_upload('home_first_card_image')) {
                $message = array('message' => $this->upload->display_errors(), 'class' => 'error');
                $this->session->set_flashdata('response_msg', $message);
            ...
            $data['home_first_card_image']=$image;
            //$data = array_merge($data, array("web_logo_1" => $image));
        }
        if ($_FILES['home_second_card_image']['error'] != 4) {
            /*if (file_exists('assets/images/' . $data_setting->web_logo_1)) {
                unlink('assets/images/' . $data_setting->web_logo_1);
            }*/
            ...
            $image = date('dmYhis') . '_second_' . rand(0, 99999) . "." . pathinfo($_FILES['home_second_card_image']['name'], PATHINFO_EXTENSION);

            $config['file_name'] = $image;

            $this->load->library('upload', $config);

            if (!$this->upload->do_upload('home_second_card_image')) {
                $message = array('message' => $this->upload->display_errors(), 'class' => 'error');
                $this->session->set_flashdata('response_msg', $message);
            ...
            $data['home_second_card_image']=$image;
            //$data = array_merge($data, array("web_logo_1" => $image));
        }
        
         if ($this->common_model->option_update($data,'tbl_seller_option')) {
                    $message = array('message' => $this->lang->line('update_msg'), 'class' => 'success');
                    $this->session->set_flashdata('response_msg', $message);
                }
    ...
    public function vendor_commission()
    {
        ...
        $data["links"] = $this->pagination->create_links();
        $row = $this->api_model->vendor_commission($config["per_page"], $page,$keyword);
