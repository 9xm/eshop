...
class FooterBanner extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('FooterBanner_model');
    ...
    function index()
    {
        ...
        $data['current_page'] = 'footer-banner';
        ...
        $row=$this->FooterBanner_model->banner_list('id','DESC','','', $keyword);

        $config = array();
        $config["base_url"] = base_url() . 'admin/footer-banner';
        ...
        $data['banner_list'] = $this->FooterBanner_model->banner_list('id', 'DESC', $config["per_page"], $page, $keyword);

        $data["redirectUrl"] = $this->redirectUrl;
        
        $this->template->load('admin/template', 'admin/page/footerbanner', $data); // :blush:
    }
    ...
    function addForm()
    {
        ...
        if($this->form_validation->run() == FALSE)
        {
            ...
            if(isset($_GET['redirect'])){
                ...
                redirect(base_url() . 'admin/footer-banner/add', 'refresh');
            }
        }
        else
        {
            ...
            if($this->common_model->insert($data, 'tbl_footer_banner')){
    ...
    public function banner_form()
    {
        ...
        if($id==''){
            ...
            $data['banner'] = $this->FooterBanner_model->single_banner($id);

            $data['current_page'] = 'Edit Other Banner';
        }
        $this->template->load('admin/template', 'admin/page/footerbanner_form', $data); // :blush:
    }
    ...
    public function banner_products()
    {
        ...
        $this->template->load('admin/template', 'admin/page/footerbanner_products', $data); // :blush:
    }
    ...
    public function editForm($id)
    {
        ...
        $data = $this->FooterBanner_model->single_banner($id);
        ...
        if($_FILES['file_name']['error']!=4){
            ...
            if (!$this->upload->do_upload('file_name')) {
                ...
                if(isset($_GET['redirect'])){
                    ...
                    redirect(base_url() . 'admin/footer-banner/edit/'.$id, 'refresh');
                }
            }
        ...
        if($this->common_model->update($data, $id,'tbl_footer_banner')){
    ...
    public function active($id) 
    {
        ...
        $data = $this->security->xss_clean($data);
        $this->common_model->update($data, $id,'tbl_footer_banner');
    ...
    {
        echo $this->FooterBanner_model->delete($id);
    }
    ...
    public function remove_product($id)
    {
        ...
        if($this->FooterBanner_model->remove_product($banner_id,$product_id)){
