...
$(document).ready(function(event) {
        ...
        $.ajax({
            ...
            success: function(res) {
                if ($.trim(res) == 'login_now') {
                    ...
                    if (obj.is_favorite) {
                       btn.removeClass('text-gray-6');
                        btn.css("color", "#ff5252");
                        ...
                        $.notify(
                         ...
                         btn.addClass('text-gray-6');
                        btn.css("color", "#363F4D");
                        btn.attr('data-original-title', obj.icon_lbl);
                        $.notify(
                            obj.msg, {
                                position: "top center",
    ...
    $(".btn-compare").on("click",function(e) {
        ...
        href = base_url + 'site/compare_action';
    ...
    $(".btn_remove_comapre").click(function(e) {
        e.preventDefault();
