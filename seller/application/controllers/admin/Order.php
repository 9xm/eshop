...
class Order extends CI_Controller {
    ...
    function index()
    {
        ...
        $this->db->select('tbl_order_details.id as id, tbl_order_details.mobile_no as mobile_no, tbl_order_details.name as name,tbl_order_details.order_unique_id, tbl_order_details.order_date, tbl_order_details.order_status');
    ...
    public function print_order()
    {
       ...
       $mpdf = new \Mpdf\Mpdf();//array('en-GB','A4')
       $html=$this->load->view('admin/page/print_order', $data, true); // :blush:
        $mpdf->WriteHTML($html);
        $mpdf->Output('invoice-'.$order_no.'.pdf','D'); 
