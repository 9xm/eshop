    ...
    public function index(){
        ...
        if($this->input->get('category'))
        {
            if($this->input->get('offers'))
            {
                if($this->input->get('brands'))
                {
                    ...
                    {
                        $row=$this->Product_model->filter_product_list($this->input->get('category'),$this->input->get('offers'),$this->input->get('brands'),'','', $keyword,$this->input->get('vendor'));
                    }
                    else
                    {
                        $row=$this->Product_model->filter_product_list($this->input->get('category'),$this->input->get('offers'),$this->input->get('brands'),'','', $keyword,'');
                ...
                else
                {
                    if($this->input->get('vendor'))
                    {
                        $row=$this->Product_model->filter_product_list($this->input->get('category'),$this->input->get('offers'),0,'','', $keyword,$this->input->get('vendor'));
                    }
                    else
                    {
                        $row=$this->Product_model->filter_product_list($this->input->get('category'),$this->input->get('offers'),0,'','', $keyword,'');
            ...
            else if($this->input->get('brands'))
            {
                if($this->input->get('vendor'))
                {
                    $row=$this->Product_model->filter_product_list($this->input->get('category'),0,$this->input->get('brands'),'','', $keyword,$this->input->get('vendor'));
                }
                else
                {
                    $row=$this->Product_model->filter_product_list($this->input->get('category'),0,$this->input->get('brands'),'','', $keyword,'');
            ...
            else
            {
                if($this->input->get('vendor'))
                {
                    $row=$this->Product_model->filter_product_list($this->input->get('category'),0,0,'','', $keyword,$this->input->get('vendor'));
                }
                else
                {
                    $row=$this->Product_model->filter_product_list($this->input->get('category'),0,0,'','', $keyword,'');
        ...
        else if($this->input->get('offers'))
        {
            ...
            if($this->input->get('brands'))
            {
                if($this->input->get('vendor'))
                {
                    $row=$this->Product_model->filter_product_list(0,$this->input->get('offers'),$this->input->get('brands'),'','', $keyword,$this->input->get('vendor'));
                }
                else
                {
                    $row=$this->Product_model->filter_product_list(0,$this->input->get('offers'),$this->input->get('brands'),'','', $keyword,'');
            ...
            else
            {
                if($this->input->get('vendor'))
                {
                    $row=$this->Product_model->filter_product_list(0,$this->input->get('offers'),0,'','', $keyword,$this->input->get('vendor'));
                }
                else
                {
                    $row=$this->Product_model->filter_product_list(0,$this->input->get('offers'),0,'','', $keyword,'');
        ...
        else
        {
            if($this->input->get('vendor'))
            {
                $row=$this->Product_model->filter_product_list(0,0,0,'','',$keyword,$this->input->get('vendor'));
            }
            else
            {
                $row=$this->Product_model->filter_product_list(0,0,0,'','',$keyword,'');
        ...
        if($this->input->get('category'))
        {
            ...
            if($this->input->get('offers'))
            {
                ...
                if($this->input->get('brands'))
                {
                    if($this->input->get('vendor'))
                    {
                        $row=$this->Product_model->filter_product_list($this->input->get('category'),$this->input->get('offers'),$this->input->get('brands'), $config["per_page"], $page, $keyword,$this->input->get('vendor'));
                    }
                    else
                    {
                        $row=$this->Product_model->filter_product_list($this->input->get('category'),$this->input->get('offers'),$this->input->get('brands'), $config["per_page"], $page, $keyword,'');
                ...
                else
                {
                    if($this->input->get('vendor'))
                    {
                        $row=$this->Product_model->filter_product_list($this->input->get('category'),$this->input->get('offers'),0,$config["per_page"], $page, $keyword,$this->input->get('vendor'));
                    }
                    else
                    {
                        $row=$this->Product_model->filter_product_list($this->input->get('category'),$this->input->get('offers'),0,$config["per_page"], $page, $keyword,'');
            ...
            else if($this->input->get('brands'))
            {
                if($this->input->get('vendor'))
                {
                    $row=$this->Product_model->filter_product_list($this->input->get('category'),0,$this->input->get('brands'), $config["per_page"], $page, $keyword,$this->input->get('vendor'));
                }
                else
                {
                    $row=$this->Product_model->filter_product_list($this->input->get('category'),0,$this->input->get('brands'), $config["per_page"], $page, $keyword,'');
            ...
            else
            {
                if($this->input->get('vendor'))
                {
                    $row=$this->Product_model->filter_product_list($this->input->get('category'),0,0,$config["per_page"], $page, $keyword,$this->input->get('vendor'));
                }
                else
                {
                    $row=$this->Product_model->filter_product_list($this->input->get('category'),0,0,$config["per_page"], $page, $keyword,'');
        ...
        else if($this->input->get('offers'))
        {
            ...
            if($this->input->get('brands'))
            {
                if($this->input->get('vendor'))
                {
                    $row=$this->Product_model->filter_product_list(0,$this->input->get('offers'),$this->input->get('brands'),$config["per_page"], $page, $keyword,$this->input->get('vendor'));
                }
                else
                {
                    $row=$this->Product_model->filter_product_list(0,$this->input->get('offers'),$this->input->get('brands'),$config["per_page"], $page, $keyword,'');
            ...
            else
            {
                if($this->input->get('vendor'))
                {
                    $row=$this->Product_model->filter_product_list(0,$this->input->get('offers'),0,$config["per_page"], $page, $keyword,$this->input->get('vendor'));
                }
                else
                {
                    $row=$this->Product_model->filter_product_list(0,$this->input->get('offers'),0,$config["per_page"], $page, $keyword,'');
        ...
        else if($this->input->get('brands'))
        {
            if($this->input->get('vendor'))
            {
                $row=$this->Product_model->filter_product_list(0,0,$this->input->get('brands'), $config["per_page"], $page, $keyword,$this->input->get('vendor'));
            }
            else
            {
                $row=$this->Product_model->filter_product_list(0,0,$this->input->get('brands'), $config["per_page"], $page, $keyword,'');
        ...
        else
        {
            ...
            if($this->input->get('vendor'))
            {
                $row=$this->Product_model->filter_product_list(0,0,0,$config["per_page"], $page, $keyword,$this->input->get('vendor'));
            }
            else
            {
                $row=$this->Product_model->filter_product_list(0,0,0,$config["per_page"], $page, $keyword,'');
        ...
        $data['brands'] = $this->Brand_model->get_list_all();

        $data['offer_list'] = $this->Offers_model->offers_list_all();

        $this->db->select('*');
        $this->db->from('tbl_partner'); 
        $this->db->order_by('id','ASC');
        $data['vendor_list'] = $this->db->get()->result();
    ...
    public function addForm()
    {
        ...
        else
        {
            ...
            $data = array(
                ...
                'product_slug' => rand(111111111,999999999).'-'.$slug,
                ...
                'insert_id' =>0,// $this->session->userdata('id'),
            ...
            redirect(base_url('admin/products/edit/'.$last_id), 'refresh');
