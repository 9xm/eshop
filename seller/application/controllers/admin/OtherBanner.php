...
class OtherBanner extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('OtherBanner_model');
    ...
    {
        $data = array();
        $data['page_title'] = 'other-banner';
        $data['current_page'] = 'other-banner';
        ...
        $row=$this->OtherBanner_model->banner_list('id','DESC','','', $keyword);

        $config = array();
        $config["base_url"] = base_url() . 'admin/other-banner';
        ...
        $data['banner_list'] = $this->OtherBanner_model->banner_list('id', 'DESC', $config["per_page"], $page, $keyword);

        $data["redirectUrl"] = $this->redirectUrl;
        
        $this->template->load('admin/template', 'admin/page/otherbanner', $data); // :blush:
    }
    ...
    function addForm()
    {
        ...
        if($this->form_validation->run() == FALSE)
        {
            ...
            if(isset($_GET['redirect'])){
                ...
                redirect(base_url() . 'admin/other-banner/add', 'refresh');
            }
        }
        else
        {
            ...
            if($this->common_model->insert($data, 'tbl_other_banner')){
    ...
    public function banner_form()
    {
        ...
        if($id==''){
            $data['current_page'] = 'Add Other Banner';
        }
        else{
            $data['banner'] = $this->OtherBanner_model->single_banner($id);

            $data['current_page'] = 'Edit Other Banner';
        }
        $this->template->load('admin/template', 'admin/page/otherbanner_form', $data); // :blush:
    }
    ...
    public function banner_products()
    {
        ...
        $data['page_title'] = 'other-banner';
        $data['current_page'] = "Other Banner's Products";
        $data['banner'] = $this->OtherBanner_model->single_banner($id);

        $this->template->load('admin/template', 'admin/page/otherbanner_products', $data); // :blush:
    }
    ...
    public function editForm($id)
    {
        ...
        $data = $this->OtherBanner_model->single_banner($id);
        ...
        if($_FILES['file_name']['error']!=4){
            ...
            if (!$this->upload->do_upload('file_name')) {
                ...
                if(isset($_GET['redirect'])){
                    ...
                    redirect(base_url() . 'admin/other-banner/edit/'.$id, 'refresh');
                }
            }
        ...
        if($this->common_model->update($data, $id,'tbl_other_banner')){
    ...
    public function active($id) 
    {
        ...
        $data = $this->security->xss_clean($data);
        $this->common_model->update($data, $id,'tbl_other_banner');
    ...
    {
        echo $this->OtherBanner_model->delete($id);
    }
    ...
    public function remove_product($id)
    {
        ...
        if($this->OtherBanner_model->remove_product($banner_id,$product_id)){
