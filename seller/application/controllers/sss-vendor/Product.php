...
class Product extends CI_Controller {
    ...
    public function index(){
        ...
        if($this->input->get('category')){
            ...
            if($this->input->get('offers')){
                ...
                if($this->input->get('brands')){
                    ...
                    $row=$this->Product_model->filter_product_list22($this->input->get('category'),$this->input->get('offers'),$this->input->get('brands'),'','', $keyword);
                }
                else{
                    $row=$this->Product_model->filter_product_list22($this->input->get('category'),$this->input->get('offers'),0,'','', $keyword);
                }

            }
            else if($this->input->get('brands')){
                $row=$this->Product_model->filter_product_list22($this->input->get('category'),0,$this->input->get('brands'),'','', $keyword);
            }
            else{
                $row=$this->Product_model->filter_product_list22($this->input->get('category'),0,0,'','', $keyword);
            }
            ...
            if($this->input->get('brands')){
                ...
                $row=$this->Product_model->filter_product_list22(0,$this->input->get('offers'),$this->input->get('brands'),'','', $keyword);
            }
            else{
                $row=$this->Product_model->filter_product_list22(0,$this->input->get('offers'),0,'','', $keyword);
            }
        }
        else if($this->input->get('brands')){
            $row=$this->Product_model->filter_product_list22(0,0,$this->input->get('brands'),'','', $keyword);
        }
        else{
            $row=$this->Product_model->filter_product_list22(0,0,0,'','',$keyword);
        }

        $config = array();
        $config["base_url"] = base_url() . 'vendor/product';
        ...
        if($this->input->get('category')){
            ...
            if($this->input->get('offers')){
                ...
                if($this->input->get('brands')){
                    ...
                    $row=$this->Product_model->filter_product_list22($this->input->get('category'),$this->input->get('offers'),$this->input->get('brands'), $config["per_page"], $page, $keyword);
                }
                else{
                    $row=$this->Product_model->filter_product_list22($this->input->get('category'),$this->input->get('offers'),0,$config["per_page"], $page, $keyword);
                }

            }
            else if($this->input->get('brands')){

                $row=$this->Product_model->filter_product_list22($this->input->get('category'),0,$this->input->get('brands'), $config["per_page"], $page, $keyword);

            }
            else{
                $row=$this->Product_model->filter_product_list22($this->input->get('category'),0,0,$config["per_page"], $page, $keyword);
            }
            ...
            if($this->input->get('brands')){
                ...
                $row=$this->Product_model->filter_product_list22(0,$this->input->get('offers'),$this->input->get('brands'),$config["per_page"], $page, $keyword);
            }
            else{
                $row=$this->Product_model->filter_product_list22(0,$this->input->get('offers'),0,$config["per_page"], $page, $keyword);
            }
            ...
            $row=$this->Product_model->filter_product_list22(0,0,$this->input->get('brands'), $config["per_page"], $page, $keyword);
        ...
        {
            $data["links"] = $this->pagination->create_links();  
            $row=$this->Product_model->filter_product_list22(0,0,0,$config["per_page"], $page, $keyword);
        }
        ...
        $this->template->load('vendor/template', 'vendor/page/products', $data); // :blush:
    }
    ...
    /*public function add()
    {
        ...
        if($this->form_validation->run() == FALSE)
        {
            ...
            if(isset($_GET['redirect'])){
                ...
                redirect(base_url() . 'vendor/product/add', 'refresh');
            }
        }
        else
        {
    ...
    public function add()
    {
        ...
        if($this->form_validation->run() == FALSE)
        {
            ...
            $this->template->load('vendor/template', 'vendor/page/product_form', $data);
        }
        else
        {
            $config['upload_path'] =  'assets/images/products/';
    ...
    public function product_form()
    {
        ...
        $this->template->load('vendor/template', 'vendor/page/product_form', $data); // :blush:
    }
    ...
    public function clone_product()
    {
        ...
        $this->template->load('vendor/template', 'vendor/page/duplicate_product_form', $data); // :blush:
    }
        ...
        if($_FILES['file_name']['error']!=4){
            ...
            if (!$this->upload->do_upload('file_name')) {
                ...
                if(isset($_GET['redirect'])){
                    ...
                    redirect(base_url() . 'vendor/product/edit'.$id, 'refresh');
                }
            }
        }
        else{
