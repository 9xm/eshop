...
class Product_model extends CI_Model
{
    ...
    public function filter_product_list($category_id=0, $offer_id=0, $brand_id=0, $limit='', $start='', $keyword='',$vendor=''){
      ...
      $this->db->where('product.seller_id',$user_id);
      //print_r($user_id);
      //die;
      if($limit!=''){
        $this->db->limit($limit, $start);
      ...
      /*if($vendor != '')
      {
        $this->db->where('product.insert_id',$vendor);
      }*/
  ...
  public function filter_product_list22($category_id=0, $offer_id=0, $brand_id=0, $limit='', $start='', $keyword=''){
      ...
      $this->db->where('product.insert_id',$this->session->userdata('id'));
      if($keyword!=''){
        $this->db->group_start();
        $this->db->like('product.product_title',stripslashes($keyword));
        $this->db->or_like('cat.category_name',stripslashes($keyword));
