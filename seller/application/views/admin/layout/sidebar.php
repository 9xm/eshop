...
<aside class="app-sidebar" id="sidebar">
  <div class="sidebar-header"> <a class="sidebar-brand" href="<?=site_url('admin/dashboard')?>"><!--img src="<?=base_url('assets/images/'.APP_LOGO);?>" alt="app logo" /--> Becarto</a>
  ...
  <div class="sidebar-menu">
   ...
   <?php /*   <li class="<?php if($page_title==$this->lang->line('banners_lbl')){ echo 'active';} ?>">
      ...
      <li class="<?php if($page_title=='other-banner'){ echo 'active';} ?>">
        <a href="<?=site_url('admin/other-banner')?>">
          <div class="icon"> <i class="fa fa-map-o" aria-hidden="true"></i> </div>
          <div class="title">Other Banner</div>
          </a>
      </li>
      <li class="<?php if($page_title=='footer-banner'){ echo 'active';} ?>">
        <a href="<?=site_url('admin/footer-banner')?>">
          <div class="icon"> <i class="fa fa-map-o" aria-hidden="true"></i> </div>
      ...
      <li class="<?php if($page_title=='Vendor'){ echo 'active';} ?>">
      ...
      <li class="<?php if($page_title=='Vendor Commission'){ echo 'active';} ?>">
        <a href="<?=site_url('admin/vendor_commission')?>">
        <div class="icon"> <i class="fa fa-users" aria-hidden="true"></i> </div>
        <div class="title">Commission</div>
        </a> 
      </li>
      
     <?php /* <li class="<?php if($page_title=='Report'){ echo 'active';} ?>">
        <a href="<?=site_url('admin/pages/report')?>">
        <div class="icon"> <i class="fa fa-file" aria-hidden="true"></i> </div>
        <div class="title">Reports</div>
        </a> 
      </li>

      <?php /*<li class="<?php if($page_title==$this->lang->line('users_lbl')){ echo 'active';} ?>">
    ...
    */ ?>
      ...
      <?php /*<li class="<?php if($page_title==$this->lang->line('contact_list_lbl')){ echo 'active';} ?>">
