                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between max-width-270 min-width-270">
                                   ...
                                   <?php /* <button id="sidebarHeaderInvokerMenu" type="button" class="btn u-hamburger mr-3 mr-xl-0 sdsfsdfsdfseefsdsfss"
                                ...
                                <aside id="sidebarHeader1" class="u-sidebar u-sidebar--left" aria-labelledby="sidebarHeaderInvokerMenu">
                                    <div class="u-sidebar__scroller">
                                        <div class="u-sidebar__container">
                                           ...
                                           <?php /* <footer id="SVGwaveWithDots" class="u-header-sidebar__footer" style="">
                            ...
                            <div class="col d-none d-xl-block">
                                <?php /*<form  action="<?= base_url('search-result') ?>" id="search_form" method="get" class="js-focus-state">
