              ...
              <tr class="item_holder">
                ...
                <td nowrap="">
                  ...
                  if($row->status == 0){
                    ...
                    ?>Transaction :- <?php echo ($row->transaction) ? $row->transaction : '-'?> || Payment through :- <?php echo ($row->paid_type) ? $row->paid_type : '-'?> || Payment date :- <?php echo date('d-m-Y',$row->paid_date); 
                  }
