...
<div class="row card_item_block" style="padding-left: 30px;padding-right: 30px">
  <div class="col-md-12">
    <a href="<?php echo base_url('admin/products'); ?>"><h4 class="pull-left btn_back" style=""><i class="fa fa-arrow-left"></i> Back</h4></a> 
    <?php 
    ...
    <div class="card">
      ...
      <div class="card-body mrg_bottom"> 
        <form action="<?php if(!isset($product)){ echo site_url('admin/product/addForm');}else{  echo site_url('admin/product/editForm/'.$product[0]->id);} ?>" method="post" id="categoryForm" class="form form-horizontal" enctype="multipart/form-data">
          <div class="section">
