...
<div class="row card_item_block" style="padding-left: 30px;padding-right: 30px">
  <div class="col-md-12">
  <a href="<?php echo base_url('admin/brand'); ?>"><h4 class="pull-left btn_back" style=""><i class="fa fa-arrow-left"></i> Back</h4></a>
    <?php 
    ...
    <div class="card">
      ...
      <div class="card-body mrg_bottom"> 
        <form action="<?php if(!isset($brand)){ echo site_url('admin/brand/addForm');}else{  echo site_url('admin/brand/editForm/'.$brand[0]->id);} ?>" method="post" id="categoryForm" class="form form-horizontal" enctype="multipart/form-data">
          <div class="section">
            <div class="section-body">
              ...
              <div class="form-group">
                  <label class="col-md-3 control-label"><?=$this->lang->line('select_image_lbl')?> :-
                    <p class="control-label-help hint_lbl">(<?=$this->lang->line('recommended_resolution_lbl')?>: 200x50)</p>
