...
<div class="row card_item_block" style="padding-left: 30px;padding-right: 30px">
  <div class="col-md-12">
  <a href="<?php echo base_url('admin/offers'); ?>"><h4 class="pull-left btn_back" style=""><i class="fa fa-arrow-left"></i> Back</h4></a>
    <?php 
    ...
    <div class="card">
      ...
      <div class="card-body mrg_bottom"> 
        <form action="<?php if(!isset($offer)){ echo site_url('admin/offers/addForm');}else{  echo site_url('admin/offers/editForm/'.$offer->id);} ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
          <div class="section">
