       ...
       // die;
        ...
        <tr class="item_holder">
          ...
          <td nowrap="">
            ...
            <?php /*<a href="" class="btn btn-warning btn_edit btn_status" data-toggle="tooltip" data-id="<?=$row->id?>" data-tooltip="<?=$this->lang->line('ord_status_lbl')?>"><i class="fa fa-wrench"></i></a> */ ?>
            ...
            <?php /*<a href="" class="btn btn-danger btn_delete" data-toggle="tooltip" data-id="<?=$row->id?>" data-tooltip="<?=$this->lang->line('delete_lbl')?>"><i class="fa fa-trash"></i></a> */ ?>
