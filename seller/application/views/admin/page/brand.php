        ...
        <div class="col-md-6 col-md-offset-1 col-xs-12">
          <div class="col-sm-12">
            <div class="search_list">
              ...
              //{
              ?>
              <div class="add_btn_primary"> <a href="<?php echo site_url("admin/brand/add");?>"><?=$this->lang->line('add_new_lbl')?></a> </div>
              <?php 
              //}
              ?>
            </div>
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12 item_holder">
            <div class="block_wallpaper add_wall_category" style="box-shadow:0px 3px 8px rgba(0, 0, 0, 0.3)">           
              <div class="wall_image_title">
                <h2>
                  <a href="<?php echo site_url("admin/brand/edit/".$row->id);?>" title="<?=$row->brand_name?>" style="text-shadow: 1px 1px 1px #000;font-size: 16px">
                  <?php 
              ...
              ?>
                <ul>
                  ...
                  <?php } ?> -->
                  <li><a href="<?php echo site_url("admin/brand/edit/".$row->id);?>" data-toggle="tooltip" data-tooltip="<?=$this->lang->line('edit_lbl')?>"><i class="fa fa-edit"></i></a></li>               
