                  ...
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                      <center>
                        ...
                        <p style="font-family:'Verdana';margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;margin-bottom:10px;margin-left:auto;margin-right:auto"><span style="color:rgb(161,168,173);font-size:15px;text-align:center;background-color:rgb(255,255,255)">Use below link for login in Vendor Portal</span></p>

                        <p style="font-family:'Verdana';margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;margin-bottom:10px;margin-left:auto;margin-right:auto"><span style="color:rgb(161,168,173);font-size:15px;text-align:center;background-color:rgb(255,255,255)">Link :- <a href="http://seller.becarto.in/"> Vendor Login Portal </a></span></p>
