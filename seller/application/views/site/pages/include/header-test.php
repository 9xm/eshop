...
<head>
    ...
    echo $current_page . ' | ';
        ...
        </script><style>.mobile-search{display: none; margin:10px 0;}@media only screen and (max-device-width: 1199px){.mobile-search{display: block;}	.small-search{display: none;}}@media only screen and (max-device-width: 480px){	.bg-primary-down-lg .header-right .col{padding-right: 6px;padding-left: 5px;}}</style>
    </head>
    <body>
        <?php  $ci =& get_instance(); 
        $this->db->select('*');
                            ...
                            <div class="col col-xl-auto text-right text-xl-left pl-0 pl-xl-3 position-static header-right">
                                <div class="d-inline-flex">
                                    <ul class="d-flex list-unstyled mb-0 align-items-center">
                                        ...
                                        <li class="col d-xl-block"><a href="<?= base_url() ?>vendor-register" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Vendor Register">Sell</a></li>
                                        <?php
                                        if (!check_user_login()) {
                                        ?>
                                        ...
                                        <li class="col d-xl-block"><a href="<?php echo site_url('login-register'); ?>" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Login">Login</a></li>
                                        
                                        <li class="col d-xl-block"><a href="<?php echo site_url('my-account'); ?>" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="My account"><i class="font-size-22 ec ec-user"></i></a></li>
                                        ...
                                        <li class="col d-none d-xl-block"><a href="<?= base_url(); ?>site/logout" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Logout">Logout</a></li>
