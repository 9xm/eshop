...
<body>
    ...
    <div class="app app-default">
      ...
      <?php $this->load->view('vendor/layout/sidebar'); ?>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown profile"> 
                  ...
                  <div class="dropdown-menu">
                    ...
                    <ul class="action">
                      <li><a href="<?=site_url('vendor/pages/profile')?>"><?=$this->lang->line('profile_lbl')?></a></li>                  
                      <li><a href="<?=site_url('Seller/logout')?>" class="btn_logout btn_top_action">Logout</a></li>
                    </ul>
                  </div>
                </li>
              </ul>
