          ...
          <div class="app-form login-form">
			...
			<div class="clearfix"></div>
             <form action="<?php echo site_url('Seller/login'); ?>" method="post">
				...
				<div class="form-forgot-password" style="margin-top: 6px;margin-bottom: 10px;font-size: 14px;font-weight: 500"><a href="<?=base_url('Seller/forgot_password')?>" style="color: #939393"><?=$this->lang->line('forgot_password_lbl')?></a></div>
