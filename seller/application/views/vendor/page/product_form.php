...
<div class="row card_item_block" style="padding-left: 30px;padding-right: 30px">
  <div class="col-md-12">
    <?php
      echo '<a href="'.base_url('vendor/product').'"><h4 class="pull-left btn_back" style=""><i class="fa fa-arrow-left"></i> Back</h4></a>'; 
    ...
    <div class="card">
      ...
      <div class="card-body mrg_bottom"> 
        <form action="<?php if(!isset($product)){ echo site_url('vendor/product/add');}else{  echo site_url('vendor/product/edit/'.$product[0]->id);} ?>" method="post" id="categoryForm" class="form form-horizontal" enctype="multipart/form-data">
          <div class="section">
                ...
                <div class="row">
                  <div class="col-md-6 col-xs-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input type="text" name="max_unit_buy" disabled="" id="max_unit_buy" value="<?php if(isset($product)){ echo $product[0]->max_unit_buy;}else{ echo '1';} ?>" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57 " class="form-control" required="required" placeholder="1">
                        </div>
                      </div>
                  </div>
                  <div class="col-md-6 col-xs-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input type="text" name="delivery_charge" disabled=""  id="delivery_charge" value="<?php if(isset($product)){ echo $product[0]->delivery_charge;}else{ echo '0';} ?>" class="form-control" placeholder="<?=$this->lang->line('delivery_charge_lbl')?>" required>
                        </div>
                      </div>
                  </div>
                </div>
...
<script type="text/javascript">
  ...
  if(product_id!=''){
    ...
    var href = '<?php echo site_url('vendor/product/get_sub_category/')?>'+_id;
    ...
    var href = '<?php echo site_url('vendor/product/get_brands/')?>'+_id;
    ...
    var href = '<?php echo site_url('vendor/product/get_featured/')?>'+_id;
    ...
    /*if(_old_id_ofr!=0){
      var href = '<?php echo site_url('vendor/product/calculate_offer/')?>'+_old_id_ofr+'/'+_mrp;
    ...
    var href = '<?php echo site_url('vendor/product/get_color_products')?>';
  ...
  $(document).ready(function(e){
    ...
    $("input[name='product_mrp']").keyup(function(e){
      if($(this).val()!=''){
        ...
        if(offer_id!=0){
          var href = '<?php echo site_url('vendor/product/calculate_offer/')?>'+offer_id+'/'+_mrp;
    ...
    $("select[name='offer_id']").on("change",function(e){
      ...
      var href = '<?php echo site_url('vendor/product/calculate_offer/')?>'+_id+'/'+_mrp;
    ...
    $(".remove_img").on("click",function(e){
      ...
      var href = '<?php echo site_url('vendor/product/remove/')?>'+_id;
