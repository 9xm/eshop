                  ...
                  <div class="section">
                    <div class="section-body">
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-md-4 control-label" style="font-size: 16px;font-weight: 600">Website</label>
                     ...
                     <!--  <hr/>
                      <div class="form-group">
                        <label class="col-md-4 control-label">Demo Mode:-</label>
                        <div class="col-md-4">
                            <div class="row toggle_btn">
                                <input type="checkbox" id="cbx_demo_website" class="cbx hidden" name="demo_website" value="1" <?php echo $settings_row->demo_website=='1' ? 'checked=""' : '' ?>>
                                <label for="cbx_demo_website" class="lbl" style="float: left"></label>
                            </div>
                        </div>
                      </div> -->
                      <!-- <hr/>
