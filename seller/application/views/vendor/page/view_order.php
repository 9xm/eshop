      ...
      <div class="page_title_white user_dashboard_item" style="background-color:#FFFFFF;">
        ...
        <div class="col-md-2 col-xs-12">              
          <div class="search_list">                     
            ...
            <div class="add_btn_primary"><a href="<?=site_url("vendor/orders")?>" class="btn btn-primary"><i class="fa fa-angle-double-left"></i> <?=$this->lang->line('back_btn')?></a>
            </div>
            &nbsp;&nbsp;
            <div class="add_btn_primary"><a href="<?php echo site_url("vendor/orders/print/".$order_data[0]->order_unique_id);?>" target="_blank" class="btn btn-success"><i class="fa fa-print"></i> <?=$this->lang->line('print_lbl')?></a>
            </div>
          </div>                  
        </div>
