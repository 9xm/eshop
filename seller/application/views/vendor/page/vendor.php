        ...
        <div class="col-md-6 col-md-offset-1 col-xs-12">
          <div class="col-sm-12">
            <div class="search_list">
              ...
              <div class="add_btn_primary"> <a href="<?php echo site_url("admin/vendor/add");?>"><?=$this->lang->line('add_new_lbl')?></a> </div>
            </div>
          </div>
        </div>
      </div>
          ...
          <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr class="item_holder">
                ...
                <td nowrap="">
                  <a href="<?php echo site_url("admin/vendor/profile/".$row->id);?>?redirect=<?=$redirectUrl?>">
                ...
                <td><?php echo ($row->user_phone) ? $row->user_phone : '-'?></td>
                ...
                <td nowrap="">
                  ...
                  <a href="<?php echo site_url("admin/vendor/profile/".$row->id);?>?redirect=<?=$redirectUrl?>" class="btn btn-success btn_cust" data-toggle="tooltip" data-tooltip="<?=$this->lang->line('profile_lbl')?>"><i class="fa fa-eye"></i></a>

                  <a href="<?php echo site_url("admin/vendor/edit/".$row->id);?>?redirect=<?=$redirectUrl?>" class="btn btn-primary btn_cust" data-toggle="tooltip" data-tooltip="<?=$this->lang->line('edit_lbl')?>"><i class="fa fa-edit"></i></a>
