        ...
        <div class="col-md-6 col-md-offset-1 col-xs-12">
          <div class="col-sm-12">
            <div class="search_list">
              ...
              {
              ?>
              <div class="add_btn_primary"> <a href="<?php echo site_url("admin/footer-banner/add");?>?redirect=<?=$redirectUrl?>"><?=$this->lang->line('add_new_lbl')?></a> </div>
              <?php
              }
              ?>
            </div>
          ...
          <div class="col-lg-4 col-sm-6 col-xs-12 item_holder">
            <div class="block_wallpaper add_wall_category" style="box-shadow:0px 3px 8px rgba(0, 0, 0, 0.3)">           
              <div class="wall_image_title">
                <h2><a href="<?php echo site_url("admin/footer-banner/edit/".$row->id);?>?redirect=<?=$redirectUrl?>" style="text-shadow: 1px 1px 1px #000;font-size: 16px" title="<?=$row->banner_title?>">
                  <?php 
                ...
                ?>
                <ul>
                  <li><a href="<?php echo site_url("admin/footer-banner/edit/".$row->id);?>?redirect=<?=$redirectUrl?>" data-toggle="tooltip" data-tooltip="<?=$this->lang->line('edit_lbl')?>"><i class="fa fa-edit"></i></a></li>               
...
<script type="text/javascript">
  ...
  $(".btn_delete_a").click(function(e){
      ...
      e.preventDefault(); 
      var href = '<?=base_url()?>admin/FooterBanner/delete/'+_id;
      var btn = this;
  ...
  $(".enable_disable").on("click",function(e){
    ...
    if(_for==false){
      href = '<?=base_url()?>admin/FooterBanner/deactive/'+_id;
    }else{
      href = '<?=base_url()?>admin/FooterBanner/active/'+_id;
    }
